...
var SidebarMenuEffects = (function() {
   ...
   * Questions Menu
   */
  function initMenu(className) {

    var container = document.getElementById( 'st-menu-menu' ),
      buttons = Array.prototype.slice.call( document.querySelectorAll( className) ),
  ...
  initMenu('.wrap_answer_question a');
  initMenu('a[href="/otviety-na-voprosy"]');
